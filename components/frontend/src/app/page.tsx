...
export default function HomePage() {
  ...
  const handleDelete = async (sessionName: string) => {
    if (
      !confirm(
        `Are you sure you want to delete agentic session "${sessionName}"? This action cannot be undone.`
      )
    ) {
      return;
    }
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold">Agentic Sessions</h1>
          <p className="text-muted-foreground mt-2">
            Manage your Ambient AI agentic jobs
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Active Agentic Sessions</CardTitle>
          <CardDescription>
            Track the status and results of your agentic jobs
          </CardDescription>
        </CardHeader>
        <CardContent>
